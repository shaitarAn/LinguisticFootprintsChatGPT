...
file1_path = os.path.join(path_to_data, "2309gpt3/results", metrics, f"{corpus}.csv")
file2_path = os.path.join(path_to_data, "2403gpt4/results", metrics, f"{corpus}.csv")
file3_path = os.path.join(path_to_data, "2407gpt4o/results", metrics, f"{corpus}.csv")
