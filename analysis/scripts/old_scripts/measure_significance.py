...
def list_corpora_per_feature(one_feature, persona):
    ...
    feature_path = f"../../feature_extraction/results/per_feature/{one_feature}/"
...
def find_significant_features_per_lang(lang, persona):
    ...
    for feature in features_list:
        ...
        try:
            ...
            df = pd.read_csv(f"../../feature_extraction/results/per_language/{lang}/{feature}.csv")
            results = kruskal_test(df)
...
def count_means_total(persona):
    ...
    for f in sorted(features_list):
        try:
            ...
            df_de = pd.read_csv(f"../../feature_extraction/results/per_language/german/{f}.csv")
            ...
            df_en = pd.read_csv(f"../../feature_extraction/results/per_language/english/{f}.csv")
            # measure significance for each feature and add to the dataframe
...
def main():
    ...
    for feature in features_list:
        try:
            make_boxplot(feature, "english", pd.read_csv(f"../../feature_extraction/results/per_language/english/{feature}.csv"))
        except FileNotFoundError:
            continue

    for feature in features_list:
        try:
            make_boxplot(feature, "german", pd.read_csv(f"../../feature_extraction/results/per_language/german/{feature}.csv"))
        except FileNotFoundError:
            continue 
