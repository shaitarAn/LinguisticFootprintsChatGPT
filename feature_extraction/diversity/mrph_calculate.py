...
def main():
    ...
    # writer1.writerow(["system", "shannon", "simpson"])
    with open("diversity_scores.csv", 'a') as outf:
        writer1 = csv.writer(outf, delimiter=',')
        for syst in sentences:
            with open(f"results_shannon/shannon_per_lemma_{syst}.csv", "w") as outf2:
                print(syst)
                ...
                writer1.writerow([syst, round(score[2]*100, 2), round(score[0]*100, 2)])
